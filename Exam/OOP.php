...
//====================================================================================
//---- Полиморфизм. Общее понятие. Понимание принципа абстрагирования, использование интрефейсов
//     и абстрактных классов.
//====================================================================================

//Полиморфизм в объектно-ориентированном программировании описывает паттерн проектирования, в котором
//классы, имеющие различную функциональность, совместно используют общий интерфейс.
//Прелесть полиморфизма в том, что коду, работающему с различными классами, не нужно знать, какой класс
//он использует, так как все они используются одинаково.

//В программировании полиморфизм используется для того, чтобы сделать приложения более модульными и
//расширяемыми. Вместо беспорядочных условных предложений, описывающих различные направления действия,
//вы создаете взаимозаменяемые объекты, которые подбираете согласно своим нуждам. Это основная задач
//полиморфизма.
...
//====================================================================================
//---- Композиция(и агрегация). Общие понятия. Умение правильного применения в разрабатываемой
//     бизнес логике.
//====================================================================================

//------------------------------- Агрегация
//Агрегация – «has a» (быть частью) случай ассоциации. Агрегация применяется когда один
//класс должен быть контейнером других классов. Причем время существования содержащихся
//классов никак не зависит от времени существования класса контейнера.
//
//Т.е. в нашем примере в качестве контейнера выступает объект класса Model. И если в ходе
//выполнения программы он будет уничтожен, это никак не повлияет на объект класса DataBase.
...
//Еще один «has a» случай ассоциации, но более строгий. В отличии от агрегации, композиция
//имеет жёсткую зависимость времени существования экземпляров класса контейнера и экземпляров
//содержащихся классов. Если контейнер будет уничтожен, то всё его содержимое будет уничтожено
//также.
...
//Различие между этими двумя видами ассоциации состоит в том, что композиция может
//быть частью одного и только одного целого, в то время как агрегация может быть
//частью нескольких объектов.
//====================================================================================